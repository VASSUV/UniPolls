package ru.mediasoft.unipolls.other.json;
...
class JsonWriter {
    ...
    private void writeObjectValueSeparator() throws IOException {
        writer.write(',');
    }
    ...
    private void writeBeginArray() throws IOException {
        writer.write('[');
    }
    ...
    private void writeArrayValueSeparator() throws IOException {
        writer.write(',');
    }
